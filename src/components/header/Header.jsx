...
const Header = () => {
  return (
    <div className="container lg:w-8/12 max-w-6xl mx-auto text-center mt-8 px-2 md:px-0">
      <div className="profile-image-wrapper">
        <img
          className=" mx-auto w-42 rounded-full border-4 border-dotted border-gray-600 p-2 hover:grayscale-50 transition-all duration-500 ease-in-out hover:scale-102 hover:skew-0.5"
          src="https://i.ibb.co/v4wz678M/shihab-img.jpg"
          alt="profile picture"
        />
        <AnimatedStatusCircle size={28} color="#4CAF50" duration={2000} />
      </div>
